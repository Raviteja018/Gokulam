...
export default function SignatureDishes() {
  const signatures = [
    ...
    },
    {
      ...
      description: 'Long-grain aged basmati rice cooked on slow dum with aromatic spices, tender chicken cuts, browned shallots, and fresh coriander. Served traditionally on a pressed green leaf plate (patravali).',
      quote: 'Served the time-honoured Indian way on an eco-friendly leaf plate.',
      image: '/assets/gokulam/biryani.webp',
      alt: 'Gokulam Special Dum Biryani served on leaf plate',
